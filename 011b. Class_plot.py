...
scatter(x_axis_1_C1, y_axis_1_C1, label='SFG', s=10, marker='x')
scatter(x_axis_1_C2, y_axis_1_C2, label='AGN', s=10, marker='+')
scatter(x_axis_1_C3, y_axis_1_C3,s=1, label='NA')
legend(loc='best')
xlabel('w2-w3')
ylabel('w1-w2')
savefig('Plot1_new_AGN_SFG.png')
clf()
scatter(x_axis_2_C1, y_axis_2_C1, label='SFG', s=1)
scatter(x_axis_2_C2, y_axis_2_C2, label='AGN', s=1)
scatter(x_axis_2_C3, y_axis_2_C3, s=1, label='NA')
legend(loc='best')
xlabel('w1-w3')
ylabel('w1')
savefig('Plot2_new_AGN_SFG.png')
