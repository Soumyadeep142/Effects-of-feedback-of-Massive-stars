...
dict={'source_id': source_id_new, 'ra': ra_new, 'ra_error': ra_error_new, 'dec': dec_new, 'dec_error': dec_error_new, 'angDist': dist_new, 'pmra': pmra_new, 'pmra_error': pmra_error_new, 'pmde': pmde_new, 'pmde_error': pmde_error_new, 'brgeo': brgeo_new, 'Brgeo': Brgeo_new}
